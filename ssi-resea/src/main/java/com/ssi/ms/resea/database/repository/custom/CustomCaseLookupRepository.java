 ...
 */
public interface CustomCaseLookupRepository {
	/**
	 ...
	 */
	LookupCaseSummaryResDTO filterCaseBasedLookupCriteria(LookupCaseSummaryReqDTO lookupDTO);

	LookupCaseSummaryResDTO filterInitialApptPendSchedulingCriteria(LookupCaseSummaryReqDTO lookupDTO);
}
