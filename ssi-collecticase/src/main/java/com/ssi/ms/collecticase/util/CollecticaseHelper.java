...
public class CollecticaseHelper {
    ...
    public static Map<String, Object> getPageInputs(CcaseInputPayload ccaseInputPayload) {
        ...
        pageInputs.put("pageNo", Objects.requireNonNullElse(pageNo, 0));
        pageInputs.put("pageSize", Objects.requireNonNullElse(pageSize, 10));
        pageInputs.put("pageAscendingEnable", Objects.requireNonNullElse(pageAscendingEnable, Boolean.TRUE));
