...
public interface CcaseEntityCmeRepository extends CrudRepository<CcaseEntityCmeDAO, Long> {
    ...
    @Query("""  
                        ...
                        from CcaseEntityCmeDAO ccaseEntityCmeDAO
                                ...
                                and ccaseEntityCmeDAO.cmeRole = :empRole
            """)
    List<EmployerListDTO> getEmployerListForWageGarnish(Long caseId, String activeInd, Long empRole);
    ...
    @Query("""   
             ...
             fn_inv_get_alv_description(ccaseEntityCmeDAO.cmeRole)||' :
             '||ccaseEntityCmeDAO.ccaseOrganizationCmoDAO.cmoName as empRepName)
            from CcaseEntityCmeDAO ccaseEntityCmeDAO
            ...
            """)
    List<OrganizationIndividualDTO> getOrganizationInfoByEmpId(Long caseId, String activeInd, List<Long> entityRoleList,
                                                               Long employerId);
    ...
    @Query(""" 
            ...
            where ccaseCmeIndividualCmiDAO.ccaseEntityCmeDAO.ccaseCasesCmcDAO.cmcId = :caseId
                ...
                and ccaseCmeIndividualCmiDAO.ccaseEntityCmeDAO.ccaseOrganizationCmoDAO is null
                and ccaseCmeIndividualCmiDAO.ccaseEntityCmeDAO.cmeActiveInd = :activeInd
                and ccaseCmeIndividualCmiDAO.ccaseEntityCmeDAO.cmeRole in (:entityRoleList)
            ...
            """)
    List<OrganizationIndividualDTO> getIndividualInfo(Long caseId, String activeInd, List<Long> entityRoleList);
    ...
    @Query(""" 
            ...
            where ccaseCmeIndividualCmiDAO.ccaseEntityCmeDAO.ccaseCasesCmcDAO.cmcId = :caseId
                ...
                and ccaseCmeIndividualCmiDAO.ccaseEntityCmeDAO.ccaseOrganizationCmoDAO is null
                and ccaseCmeIndividualCmiDAO.ccaseEntityCmeDAO.cmeActiveInd = :activeInd
                and ccaseCmeIndividualCmiDAO.ccaseEntityCmeDAO.cmeId = :entityId
                ORDER by ccaseCmeIndividualCmiDAO.ccaseEntityCmeDAO.cmeId, ccaseCmeIndividualCmiDAO.ccaseEntityCmeDAO.cmeType,
                        ccaseCmeIndividualCmiDAO.cmiFirstName, ccaseCmeIndividualCmiDAO.cmiLastName
            """)
    List<OrganizationIndividualDTO> getIndividualInfoByEntityId(Long caseId, String activeInd, Long entityId);
